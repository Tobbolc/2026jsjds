...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "",
    appName: "基于ResNet50的病虫害识别及防治预警系统",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"基于ResNet50的病虫害识别及防治预警系统","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
