...
/***/ 34:
/*!****************************************************************************************************!*\
  !*** C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \****************************************************************************************************/
...
/***/ 35:
/*!*********************************************************************************!*\
  !*** C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/pages/index/index.vue ***!
  \*********************************************************************************/
/*! no static exports found */
...
/***/ 36:
/*!****************************************************************************************************************!*\
  !*** C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \****************************************************************************************************************/
...
var render = function () {
  ...
  var l0 = !!g0
    ? _vm.__map(_vm.historyList, function (item, index) {
        ...
        var m0 = _vm.getImageUrl(item.imagePath)
        return {
          $orig: $orig,
          m0: m0,
        }
    ...
    : null
  var g1 = !!g0 ? !_vm.hasMore && _vm.historyList.length : null
  var m1 =
    _vm.showResultPopup && _vm.recognitionResult
      ? _vm.getDiseaseClass(_vm.recognitionResult.diseaseInfo.severityLevel)
      : null
  var m2 =
    _vm.showResultPopup && _vm.recognitionResult
      ? _vm.getDiseaseClass(_vm.recognitionResult.diseaseInfo.severityLevel)
...
/***/ 38:
/*!**********************************************************************************************************!*\
  !*** C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 39:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    ...
    submitImage: function submitImage() {
      ...
      uni.uploadFile({
        url: _config.default.baseUrl + '/api/predict',
        ...
        success: function success(res) {
          ...
          if (result.success && result.data) {
            ...
            if (data.diseaseInfo && data.diseaseInfo.severityLevel) {
              _this2.recognitionResult = JSON.parse(JSON.stringify(data));
              _this2.showResultPopup = true;

              // 刷新历史记录（重置到第一页）
              _this2.currentPage = 1;
              _this2.hasMore = true;
              _this2.getHistoryList(1);
              uni.showToast({
                title: '识别成功',
                icon: 'success'
              });
    ...
    // 获取严重程度文本
    getSeverityText: function getSeverityText(level) {
      // 直接访问值而不是响应式对象
      var actualLevel = level && level.toString();
      var textMap = {
        'healthy': '健康',
        'general': '一般',
        'serious': '严重'
    ...
    // 获取病害状态的样式类
    getDiseaseClass: function getDiseaseClass(level) {
      if (!level) return '';
      var classMap = {
        '健康': 'status-healthy',
        '一般': 'status-warning',
    ...
    getHistoryList: function getHistoryList() {
      ...
      uni.request({
        url: _config.default.baseUrl + '/api/history',
        method: 'GET',
        data: {
          user_id: this.userInfo.userId,
          page: page,
        ...
        success: function success(res) {
          ...
          if (res.data.success) {
            var newRecords = res.data.records.map(function (record) {
            ...
            if (page === 1) {
              _this3.historyList = newRecords;
            } else {
              _this3.historyList = [].concat((0, _toConsumableArray2.default)(_this3.historyList), (0, _toConsumableArray2.default)(newRecords));
            }
            _this3.hasMore = res.data.hasMore;
            _this3.currentPage = page;
            console.log('当前页数:', _this3.currentPage);
            console.log('是否还有更多:', _this3.hasMore);
            console.log('当前列表长度:', _this3.historyList.length);
          }
        },
        fail: function fail(err) {
    ...
    loadMore: function loadMore() {
      ...
      if (this.hasMore && !this.isLoading) {
        setTimeout(function () {
          console.log('开始加载第', _this4.currentPage + 1, '页');
          _this4.getHistoryList(_this4.currentPage + 1);
        }, 100);
      }
    },
    // 显示历史记录详情
    showHistoryDetail: function showHistoryDetail(item) {
      var _this5 = this;
      // 添加调试日志
      console.log('查看记录详情:', item);
      uni.request({
        url: _config.default.baseUrl + '/api/record/detail',
        method: 'GET',
        data: {
        ...
        success: function success(res) {
          ...
          if (res.data.success) {
            _this5.recognitionResult = res.data.data;
            _this5.showResultPopup = true;
          } else {
            uni.showToast({
              title: '获取详情失败',
              icon: 'none'
    ...
    getImageUrl: function getImageUrl(path) {
      ...
      var url = _config.default.baseUrl + '/' + path.replace(/^\/+/, '');
...
/***/ 41:
/*!******************************************************************************************************************!*\
  !*** C:/Users/93368/Desktop/软著/基于ResNet50的病虫害识别及防治预警系统/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
